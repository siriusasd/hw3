...
double x, y;
char bufff[256];
//void select_threshold_angle(Arguments *in, Reply *out);
//void getAcc(Arguments *in, Reply *out);

//RPCFunction rpcAcc(&getAcc, "getAcc");
//RPCFunction gesture_UI(&select_threshold_angle, "select");
//RPCFunction tilt_angle_detection(&LEDControl, "LEDControl");
...
void choose_function()
{
    ...
    printf("%s\r\n", outbuf);
    //printf("%d\n",strlen(buf5));
    if(strcmp(buf5,"/LEDControl/run 1 1\n\r")==0)
    {
        myled3=1;
        uLCD.cls();
        uLCD.printf("\ngesture UI:\n");
    ...
    else if(strcmp(buf5,"/LEDControl/run 2 1\n\r")==0)
    {
        myled2=1;
        uLCD.cls();
